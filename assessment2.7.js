...
// CODE HERE
var me = {firstname:"Chris", age:36, state:"Oregon"}
...
// CODE HERE
var adjustCount = {
      upVote:function(num1,num2){
     console.log(num1+1);
       },
       downVote: function(num2,num1){
     console.log(num2-1)
       }
     };
...
// CODE HERE
var myFriends = ["Jobob", "Sam", "Chris", "Tango" ];
...
var indexes =[]
 function indexFinder(num){
   for(i=0;i<randomNumbers.length;i++){
     return randomNumbers.push(i)
